...
!(function (t, i) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? define("geekros_joystick", [], i)
        : "object" == typeof exports
        ? (exports.geekros_joystick = i())
        : (t.geekros_joystick = i());
})(window, function () {
    return (
        (o = {}),
        (n.m = e =
            [
                function (t, i, e) {
                    ...
                    function O() {}
                    y
                        ? (l = { start: "pointerdown", move: "pointermove", end: "pointerup, pointercancel" })
                        : m
                        ? (l = { start: "MSPointerDown", move: "MSPointerMove", end: "MSPointerUp" })
                        : f
                        ? ((l = { start: "touchstart", move: "touchmove", end: "touchend, touchcancel" }), (g = e))
                        : (l = e),
                        ...
                        (O.prototype.off = function (t, i) {
                            return (
                                ...
                                void 0 === t
                                    ...
                                    : this._handlers_[t] && 0 <= this._handlers_[t].indexOf(i) && this._handlers_[t].splice(this._handlers_[t].indexOf(i), 1),
                                this
                            );
                        }),
                    ...
                    (w.prototype = new e()),
                        ...
                        (w.prototype.stylize = function () {
                            ...
                            var t = this.options.fadeTime + "ms",
                                ...
                                t = {};
                            return (
                                (t.el = { position: "absolute", opacity: this.options.restOpacity, display: "block", zIndex: 999 }),
                                (t.back = {
                                    position: "absolute",
                                    display: "block",
                                ...
                                a(t.el, e),
                                "circle" === this.options.shape && a(t.back, i),
                                a(t.front, i),
                                this.applyStyles(t),
                                this
                            );
                        ...
                        (w.prototype.hide = function (i) {
                            ...
                            return (
                                e.options.dataOnly ||
                                    ...
                                    e.options.restJoystick && e.setPosition(i, { x: 0, y: 0 })),
                                e
                            );
                        }),
                        (w.prototype.setPosition = function (t, i) {
                            ...
                            o = { front: {} };
                            (o.front = { left: e.frontPosition.x + "px", top: e.frontPosition.y + "px" }),
                                e.applyStyles(i),
                                e.applyStyles(o),
                        ...
                        (w.prototype.computeDirection = function (t) {
                            ...
                            if (
                                ...
                                var a = {};
                                for (d in ((this.direction = { x: e, y: o, angle: i }), (t.direction = this.direction), p)) p[d] === this.direction[d] && (a[d] = !0);
                    ...
                    (T.prototype = new e()),
                        ...
                        (T.prototype.prepareNipples = function () {
                            ...
                            (o.on = this.on.bind(this)),
                                ...
                                (o.get = function (t) {
                                    ...
                                    for (var i = 0, e = o.length; i < e; i += 1) if (o[i].identifier === t) return o[i];
                                    return !1;
                                });
                        }),
                        ...
                        (T.prototype.createNipple = function (t, i) {
                            var e,
                                ...
                                r = this.options;
                            t.x && t.y
                                ? (s = { x: t.x - (n.x + this.box.left), y: t.y - (n.y + this.box.top) })
                                : (t.top || t.right || t.bottom || t.left) &&
                                  (((e = document.createElement("DIV")).style.display = "hidden"),
                                  (e.style.top = t.top),
                                  (e.style.right = t.right),
                                  (e.style.bottom = t.bottom),
                                  (e.style.left = t.left),
                                  (e.style.position = "absolute"),
                                  r.zone.appendChild(e),
                                  (o = e.getBoundingClientRect()),
                                  r.zone.removeChild(e),
                                  (s = t),
                            ...
                            return (
                                r.dataOnly || (x(t.ui.el, s), x(t.ui.front, t.frontPosition)),
                                this.nipples.push(t),
                        ...
                        (T.prototype.processOnMove = function (t) {
                            ...
                            if (((u = t), isNaN(u.buttons) ? 0 !== u.pressure : 0 !== u.buttons)) {
                                ...
                                i.dynamicPage && ((f = o.el.getBoundingClientRect()), (o.position = { x: n.x + f.left, y: n.y + f.top })), (o.identifier = e);
                                ...
                                "circle" === o.options.shape
                                    ? ((g = Math.min(h, s)), (d = o.position), (p = g), (a = { x: 0, y: 0 }), (m = b((m = u))), (a.x = d.x - p * Math.cos(m)), (a.y = d.y - p * Math.sin(m)), (m = a))
                                    : ((a = r),
                                      (c = o.position),
                                      (l = s),
                                      (m = { x: Math.min(Math.max(a.x, c.x - l), c.x + l), y: Math.min(Math.max(a.y, c.y - l), c.y + l) }),
                                      (g = v(m, o.position))),
                                    i.follow
                                        ? s < h &&
                                          ((c = r.x - m.x),
                                ...
                                var m = r.x - o.position.x,
                                    g = r.y - o.position.y;
                                (o.frontPosition = { x: m, y: g }), i.dataOnly || x(o.ui.front, o.frontPosition);
                                i = {
                                ...
                                ((i = o.computeDirection(i)).angle = { radian: b(180 - u), degree: 180 - u }), o.trigger("move", i), this.trigger("move " + o.id + ":move", i);
                        ...
                        (T.prototype.processOnEnd = function (t) {
                            ...
                            o &&
                                (e.dataOnly ||
                                    o.hide(function () {
                                        "dynamic" === e.mode &&
                                            (o.trigger("removed", o), i.trigger("removed " + o.id + ":removed", o), i.manager.trigger("removed " + o.id + ":removed", o), o.destroy());
                                    }),
                        ...
                        function i() {
                            ...
                            e.collections.forEach(function (t) {
                                t.forEach(function (t) {
                                    (i = t.el.getBoundingClientRect()), (t.position = { x: e.scroll.x + i.left, y: e.scroll.y + i.top });
                                });
                            });
                        }
        ...
        (n.t = function (i, t) {
            ...
            if ((n.r(e), Object.defineProperty(e, "default", { enumerable: !0, value: i }), 2 & t && "string" != typeof i))
                for (var o in i)
                    n.d(
                        e,
                        o,
